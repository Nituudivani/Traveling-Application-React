...
function App() {
  ...
  return (
    <div>
      {signupClick ? <Signup  setSigInpClick={setSigInpClick} setSignupClick={setSignupClick}/> : <></>}
      {signInClick ? <SignIn setSignupClick={setSignupClick}   setSigInpClick={setSigInpClick}/> : <></>}

 <BrowserRouter>
   
 <Navbar setSignupClick={setSignupClick} signupClick={signupClick}  setSigInpClick={setSigInpClick} signInClick={signInClick} />
        <Routes>
